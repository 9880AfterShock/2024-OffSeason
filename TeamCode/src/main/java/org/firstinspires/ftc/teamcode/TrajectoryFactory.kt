...
RandStartPose2 = Pose2d(10.0,63.0.switchColor, -90.0.switchAngle.toRadians)
    ...
    OutRandToScore = Pose2d(52.0, 44.0.switchColor, 0.0.toRadians)
    ...
    InsRandToScore = Pose2d(53.5, 33.0.switchColor, 0.0.switchAngle.toRadians)
...
Pose2 = Pose2d(10.0,63.5.switchColor, 0.0)
    ...
    outsideScoreToBackup = drive.trajectoryBuilder(OutRandToScore, 0.0.toRadians)
        .back(10.0)
        .build()
    scoreOutsideToPark = drive.trajectoryBuilder(Pose2d(outsideScoreToBackup.end().vec(), 270.0.toRadians),270.0.toRadians)
    ...
    scoreCenterToPark = drive.trajectoryBuilder(Pose2d(centerScoreToBackup.end().vec(), 0.0.toRadians),0.0.toRadians)
        .splineToSplineHeading(ParkPos, 320.0.switchAngle.toRadians)
        .build()
    ...
    insideToBackup1_1 = drive.trajectoryBuilder(InsideRandPose1, 0.0.toRadians)
        .back(10.0)
        .build()
    insideToBackup1 = drive.trajectoryBuilder(Pose2d(insideToBackup1_1.end().vec(), 330.0.toRadians), 330.0.switchAngle.toRadians)
        .back(6.0)
        .build()
