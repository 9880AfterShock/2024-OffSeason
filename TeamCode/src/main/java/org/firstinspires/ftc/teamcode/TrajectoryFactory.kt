...
RandStartPose2 = Pose2d(10.0,63.0.switchColor, -90.0.switchAngle.toRadians)
    ...
    OutRandToScore = Pose2d(52.0, 32.0.switchColor, 0.0.switchAngle.toRadians)
    OutRandToScore2 = Pose2d(52.0, 41.5.switchColor, 0.0.switchAngle.toRadians)
    ...
    InsRandToScore = Pose2d(52.0, 41.5.switchColor, 0.0.switchAngle.toRadians)
    InsRandToScore2 = Pose2d(52.0, 32.0.switchColor, 0.0.switchAngle.toRadians)
...
RandStartPose1 = Pose2d(-34.0,63.0.switchColor, -90.0.switchAngle.toRadians)
        OutsideRandPose1 = Pose2d(-41.0,35.0.switchColor,200.0.switchAngle.toRadians)
