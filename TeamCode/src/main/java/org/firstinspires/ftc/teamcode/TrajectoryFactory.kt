...
RandStartPose2 = Pose2d(10.0,63.0.switchColor, -90.0.switchAngle.toRadians)
    ...
    CenterRandPose2 = Pose2d(11.0, 36.0.switchColor, 270.0.switchAngle.toRadians)
    ...
    InsRandToScore = Pose2d(49.0, 38.0.switchColor, 0.0.switchAngle.toRadians)
...
RandStartPose1 = Pose2d(-34.0,63.0.switchColor, -90.0.switchAngle.toRadians)
        ...
        CenterRandPose1 = Pose2d(-34.0,36.0.switchColor,270.0.switchAngle.toRadians)
