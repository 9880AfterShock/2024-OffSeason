...
RandStartPose2 = Pose2d(10.0,63.0.switchColor, -90.0.switchAngle.toRadians)
    ...
    OutRandToScore = Pose2d(49.0, 38.0.switchColor, 0.0.toRadians)
    CenterRandPose2 = Pose2d(11.0, 30.0.switchColor, 270.0.switchAngle.toRadians)
    CentRandToScore = Pose2d(49.0, 36.0.switchColor, 0.0.switchAngle.toRadians)
    CenterReverse2 = Pose2d(11.0, 33.5.switchColor, 0.0.switchAngle.toRadians)
    InsideRandPose2 = Pose2d(8.0, 34.0.switchColor, 180.0.switchAngle.toRadians)
    InsRandToScore = Pose2d(49.0, 40.0.switchColor, 0.0.switchAngle.toRadians)
...
Pose2 = Pose2d(10.0,63.5.switchColor, 0.0)
    ...
    outsideScoreToBackup = drive.trajectoryBuilder(OutRandToScore, 0.0.toRadians)
        .back(6.0)
        .build()
    scoreOutsideToPark = drive.trajectoryBuilder(Pose2d(outsideScoreToBackup.end().vec(), 0.0.toRadians),0.0.toRadians)
