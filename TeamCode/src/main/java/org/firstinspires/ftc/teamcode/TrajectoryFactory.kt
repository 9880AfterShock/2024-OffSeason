...
RandStartPose2 = Pose2d(10.0,63.0.switchColor, -90.0.switchAngle.toRadians)
    OutsideRandPose2 = Pose2d(24.0, 35.0.switchColor, -90.0.switchAngle.toRadians)
    CenterRandPose2 = Pose2d(11.0, 32.0.switchColor, 270.0.switchAngle.toRadians)
    CentRandToScore = Pose2d(52.0, 35.5.switchColor, 0.0.switchAngle.toRadians)
    ...
    LeftScorePos = Pose2d(52.0, 41.5.switchColor, 0.0.switchAngle.toRadians)
    RightScorePos = Pose2d(52.0, 29.0.switchColor, 0.0.switchAngle.toRadians)
...
RandStartPose1 = Pose2d(-34.0,63.0.switchColor, -90.0.switchAngle.toRadians)
        OutsideRandPose1 = Pose2d(-45.5,35.0.switchColor,260.0.switchAngle.toRadians)
        CenterRandPose1 = Pose2d(-34.5,32.0.switchColor,270.0.switchAngle.toRadians)
        CenterReverse1 = Pose2d(-34.0,33.5.switchColor, 0.0.switchAngle.toRadians)
        InsideRandPose1 = Pose2d(-27.5,35.0.switchColor,290.0.switchAngle.toRadians)
...
Pose2 = Pose2d(10.0,63.5.switchColor, 0.0)
    ...
    startToOutside1 = drive.trajectoryBuilder(RandStartPose1, 180.0.switchAngle.toRadians)
        ...
        .build()
    outsideToBackup2 = drive.trajectoryBuilder(OutsideRandPose2, 270.0.toRadians)
        .back(10.0)
        .build()
    outsideToBackup1 = drive.trajectoryBuilder(OutsideRandPose1, 270.0.toRadians)
        .back(23.0)
        .build()
    outsideToForeward1 = drive.trajectoryBuilder(Pose2d(outsideToBackup1.end().vec(), 0.0), 0.0.switchAngle.toRadians)
        .forward(34.0)
        .build()
    outside2ToScore = drive.trajectoryBuilder(Pose2d(outsideToBackup2.end().vec(), 0.0.toRadians),0.0.toRadians)
    ...
    outsideScoreToBackup2 = drive.trajectoryBuilder(LeftScorePos, 0.0.toRadians)
            .back(14.0)
            .build()
    scoreOutsideToPark = drive.trajectoryBuilder(Pose2d(outsideScoreToBackup.end().vec(), 270.0.switchAngle.toRadians),270.0.switchAngle.toRadians)
        .splineToSplineHeading(ParkPos, -69.420.switchAngle.toRadians)
        .build()
    scoreOutsideToPark2 = drive.trajectoryBuilder(Pose2d(outsideScoreToBackup2.end().vec(), 270.0.switchAngle.toRadians),270.0.switchAngle.toRadians)
        .splineToSplineHeading(ParkPos, -69.420.switchAngle.toRadians)
        .build()
    ...
    center1ToScore = drive.trajectoryBuilder(Pose2d(centerToBackup1.end().vec(), 0.0.toRadians),0.0.toRadians)
        ...
        .build()
    centerScoreToBackup = drive.trajectoryBuilder(CentRandToScore,0.0.toRadians)
        .back(14.0)
        .build()
    scoreCenterToPark = drive.trajectoryBuilder(Pose2d(centerScoreToBackup.end().vec(), 0.0.toRadians),0.0.toRadians)
        .splineToSplineHeading(ParkPos, -69.420.switchAngle.toRadians)
        .build()
    ...
    insideToBackup1 = drive.trajectoryBuilder(InsideRandPose1, 0.0.toRadians)
        .back(24.0)
        .build()
    insideToForward1 = drive.trajectoryBuilder(Pose2d(insideToBackup1.end().vec(), 0.0), 0.0.switchAngle.toRadians)
        .forward(30.0)
        .build()
    ...
    insideScoreToBackup2 = drive.trajectoryBuilder(RightScorePos, 0.0.toRadians)
            .back(14.0)
            .build()
    scoreInsideToPark = drive.trajectoryBuilder(Pose2d(insideScoreToBackup.end().vec(), 0.0.toRadians), 0.0.switchAngle.toRadians)
        .splineToSplineHeading(ParkPos, -69.420.switchAngle.toRadians)
        .build()
    scoreInsideToPark2 = drive.trajectoryBuilder(Pose2d(insideScoreToBackup2.end().vec(), 0.0.toRadians), 0.0.switchAngle.toRadians)
        .splineToSplineHeading(ParkPos, -69.420.switchAngle.toRadians)
        .build()
    //Non Rand
