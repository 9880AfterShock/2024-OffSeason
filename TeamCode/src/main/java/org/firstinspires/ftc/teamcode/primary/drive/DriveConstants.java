...
public class DriveConstants {
     ...
     */
    public static final double TICKS_PER_REV = 2400.0;
     ...
     * empirically tuned.
     */
    public static double kV = 0.02035; //old is 1.0 / rpmToVelocity(MAX_RPM)
    ...
    public static double MAX_ANG_ACCEL = Math.toRadians(23);
